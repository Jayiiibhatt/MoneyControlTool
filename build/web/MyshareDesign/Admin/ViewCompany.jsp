                    ...
                    <tbody>
                        <s:iterator value="%{companyprofile}">
                            ...
                            <tr> 
                                ...
                                <td><input type="button" id="editbutton"  value="Edit" onclick="editdialog(<s:property value="tinnumber" />)"/></td>  
                                <td><input type="button" id="deletebutton" onclick="deletedialog(<s:property value="tinnumber" />)" style="background-image:url('<%=application.getContextPath()%>/MyshareDesign/images/Remove.png'); width:30px; float:right; height:30px; margin-top: 3px;"/></td>  
                            </tr>
