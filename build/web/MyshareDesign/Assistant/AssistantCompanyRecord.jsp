...
<s:form theme="simple" action="AssistantCompanyRecord">
    <div class="formlayout">
        <h2>Add Company Daily Record</h2>
        <p><span>Company Issue Name : </span><s:select name="companyissuename" list="%{companytablerec}" listKey="tinnumber" listValue="companyissuename" style=" margin: 20px auto;padding: 10px;"/></p>
