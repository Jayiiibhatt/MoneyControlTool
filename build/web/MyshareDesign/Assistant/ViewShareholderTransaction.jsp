<%@include file="AssistantHeader.jsp" %>
        ...
        <div id="container">                
        <div id="demo_jui">
         <div style="text-align:center;"><h2 style="color: red"><b>ShareHolder Transaction Records</b></h2></div>       
                <table id="cmpny" class="display">
                    <thead>
                        <tr>
                            <th>Tin Number</th>
                            <th>Shareholder AccNo.</th>
                    ...
                    <tbody>
                        <s:iterator value="%{shareholdertransactionrecord}">
                                                        
                            <tr> 
                                <td><s:property value="id.tinnumber" /></td>
                                <td><s:property value="id.shareholder_id" /></td>
                                <td><s:property value="transactionmode" /></td>
                                <td><s:property value="date" /> </td>                                
                                <td><s:property value="numberofissue" /></td>
                                <td><s:property value="currentvalue" /></td>
