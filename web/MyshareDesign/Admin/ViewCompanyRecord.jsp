                    ...
                    <tbody>
                        <s:iterator value="%{companyrecord1}">
                            ...
                            <tr> 
                                ...
                                <td><input type="button" id="deletebutton" onclick="deletedialog(<s:property value="recordid" />)" style="background-image:url('<%=application.getContextPath()%>/MyshareDesign/images/Remove.png'); width:30px; float:right; height:30px; margin-top: 3px;"/></td>     
                            </tr>
